...
module.exports = async function render(scope, params) {
  ...
  try {
    ...
    try {
      ...
      request.query = new URLSearchParams(request.search); //pre-execute lazy route
      ...
      const Helmet = (route || {}).helmet || route.component.helmet || (() => /*#__PURE__*/React.createElement(Fragment, null)); //pre-execute lazy callbacks
